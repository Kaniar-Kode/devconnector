                    ...
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <form noValidate onSubmit={this.onSubmit}>
                                ...
                                <div className="form-group">
                                    <input type="password" className={classnames('form-control form-control-lg', { 'is-invalid': errors.passwordc })}
                                        placeholder="Confirm Password" name="passwordc" value={this.state.passwordc} onChange={this.onChange} />
                                    {errors.passwordc && (<div className="invalid-feedback">{errors.passwordc}</div>)}
                                </div>
